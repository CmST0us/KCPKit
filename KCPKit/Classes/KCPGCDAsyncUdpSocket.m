...
NSString *const KCPGCDAsyncUdpSocketException = @"KCPGCDAsyncUdpSocketException";
NSString *const KCPGCDAsyncUdpSocketErrorDomain = @"KCPGCDAsyncUdpSocketErrorDomain";

NSString *const KCPGCDAsyncUdpSocketQueueName = @"KCPGCDAsyncUdpSocket";
NSString *const KCPGCDAsyncUdpSocketThreadName = @"KCPGCDAsyncUdpSocket-CFStream";

enum KCPGCDAsyncUdpSocketFlags
{
...
enum KCPGCDAsyncUdpSocketConfig
{
...
@interface KCPGCDAsyncUdpSocket ()
{
	...
	KCPGCDAsyncUdpSocketReceiveFilterBlock receiveFilterBlock;
	dispatch_queue_t receiveFilterQueue;
	BOOL receiveFilterAsync;
	
	KCPGCDAsyncUdpSocketSendFilterBlock sendFilterBlock;
...
@implementation KCPGCDAsyncUdpSocket
...
- (instancetype)initWithDelegate:(id<KCPGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	LogTrace();
...
- (instancetype)initWithDelegate:(id<KCPGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	LogTrace();
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([KCPGCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (id<KCPGCDAsyncUdpSocketDelegate>)delegate
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
		return delegate;
...
- (void)setDelegate:(id<KCPGCDAsyncUdpSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id<KCPGCDAsyncUdpSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id<KCPGCDAsyncUdpSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id<KCPGCDAsyncUdpSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id<KCPGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
	dispatch_block_t block = ^{
...
- (void)setDelegate:(id<KCPGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id<KCPGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (void)notifyDidConnectToAddress:(NSData *)anAddress
{
	...
	__strong id<KCPGCDAsyncUdpSocketDelegate> theDelegate = delegate;
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:KCPGCDAsyncUdpSocketErrorDomain
	                           code:KCPGCDAsyncUdpSocketBadConfigError
	                       userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:KCPGCDAsyncUdpSocketErrorDomain
	                           code:KCPGCDAsyncUdpSocketBadParamError
	                       userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"KCPGCDAsyncUdpSocketSendTimeoutError",
	                                                     @"KCPGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Send operation timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:KCPGCDAsyncUdpSocketErrorDomain
	                           code:KCPGCDAsyncUdpSocketSendTimeoutError
	                       userInfo:userInfo];
}

- (NSError *)socketClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"KCPGCDAsyncUdpSocketClosedError",
	                                                     @"KCPGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Socket closed", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:KCPGCDAsyncUdpSocketErrorDomain code:KCPGCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:KCPGCDAsyncUdpSocketErrorDomain
	                           code:KCPGCDAsyncUdpSocketOtherError
	                       userInfo:userInfo];
}
...
- (BOOL)createSocket4:(BOOL)useIPv4 socket6:(BOOL)useIPv6 error:(NSError * __autoreleasing *)errPtr
{
	...
	int(^createSocket)(int) = ^int (int domain) {
         ...
         *  #535(KCPGCDAsyncUdpSocket can not send data when data is greater than 9K)
         *
         *
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	GCDAsyncUdpSendPacket *packet = [[GCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [KCPGCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)setSendFilter:(KCPGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setSendFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setSendFilter:(KCPGCDAsyncUdpSocketSendFilterBlock)filterBlock
            withQueue:(dispatch_queue_t)filterQueue
       isAsynchronous:(BOOL)isAsynchronous
{
	KCPGCDAsyncUdpSocketSendFilterBlock newFilterBlock = NULL;
...
- (void)setReceiveFilter:(KCPGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setReceiveFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setReceiveFilter:(KCPGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous
{
	KCPGCDAsyncUdpSocketReceiveFilterBlock newFilterBlock = NULL;
	dispatch_queue_t newFilterQueue = NULL;
...
+ (void)listenerThread:(id)unused
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:KCPGCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(KCPGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(KCPGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		KCPGCDAsyncUdpSocket *asyncUdpSocket = (__bridge KCPGCDAsyncUdpSocket *)pInfo;
