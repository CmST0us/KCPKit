...
extern NSString *const KCPGCDAsyncUdpSocketException;
extern NSString *const KCPGCDAsyncUdpSocketErrorDomain;

extern NSString *const KCPGCDAsyncUdpSocketQueueName;
extern NSString *const KCPGCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(KCPGCDAsyncUdpSocketErrorDomain, KCPGCDAsyncUdpSocketError) {
	KCPGCDAsyncUdpSocketNoError = 0,          // Never used
	KCPGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	KCPGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	KCPGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	KCPGCDAsyncUdpSocketClosedError,          // The socket was closed
	KCPGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class KCPGCDAsyncUdpSocket;

@protocol KCPGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(KCPGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(KCPGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(KCPGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(KCPGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
 ...
 * Example:
 * 
 * KCPGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^KCPGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^KCPGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface KCPGCDAsyncUdpSocket : NSObject

/**
 * KCPGCDAsyncUdpSocket uses the standard delegate paradigm,
...
- (instancetype)initWithDelegate:(nullable id<KCPGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<KCPGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<KCPGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<KCPGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<KCPGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<KCPGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<KCPGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<KCPGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means KCPGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, KCPGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, KCPGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, KCPGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that KCPGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about KCPGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable KCPGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable KCPGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * KCPGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, KCPGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about KCPGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable KCPGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable KCPGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The KCPGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally KCPGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
